...
namespace SmsWorkbench
{
    ...
    public static class DialogFactory
    {
        ...
        /// </summary>
        public static Button CreateCancelButton(string text = "Batal", double width = 76)
        {
            return new Button
            {
                Content = text,
        ...
        /// </summary>
        public static async Task ShowInfoAsync(Window owner, string title, string message, string okText = "Mengerti")
        {
