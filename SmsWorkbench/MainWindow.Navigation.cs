namespace SmsWorkbench
{
    public partial class MainWindow
    {
        ...
        {
            string detail = string.IsNullOrWhiteSpace(action) ? "Lakukan tindakan ini" : action.Trim();
            ShowThemedInfoDialog("Email belum dipilih", $"Silakan centang atau pilih akun email terlebih dahulu sebelum {detail}.");
        }
        ...
        private void ShowAll_Click(object sender, RoutedEventArgs e) => SetScope("Semua");

        private void ShowMailboxPool_Click(object sender, RoutedEventArgs e) => SetScope("Kolam Email");

        private void ShowRegistered_Click(object sender, RoutedEventArgs e) => SetScope("Telah Terdaftar");

        private void ShowPending_Click(object sender, RoutedEventArgs e) => SetScope("Menunggu");
