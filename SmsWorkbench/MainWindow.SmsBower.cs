namespace SmsWorkbench
{
    public partial class MainWindow
    {
        private async Task<bool> ShowSmsBowerOneClickDialogAsync()
        {
            ...
            {
                ShowThemedInfoDialog("SMSBower belum dikonfigurasi", "Silakan isi SMSBower API Key di kategori SMS pada pengaturan terlebih dahulu.");
                return false;
            }
            ...
            catch (Exception exc)
            {
                ...
                ShowThemedInfoDialog("SMSBower gagal dimuat", "Tidak dapat membaca wilayah dan harga nomor OpenAI:" + exc.Message);
                return false;
            }
            finally
            {
            ...
            {
                ShowThemedInfoDialog("Sementara tidak ada nomor", "SMSBower saat ini tidak memiliki nomor OpenAI yang tersedia.");
                return false;
            }
            ...
            {
                Title = "Ambil kode dengan satu klik",
                Owner = this,
            ...
            {
                Text = "Saldo platform saat ini: $" + balance,
                FontSize = 13,
            ...
            var servicePanel = CreateSmsBowerDialogRow("Penyedia layanan", out ContentControl serviceHost);
            ...
            var countryPanel = CreateSmsBowerDialogRow("Negara atau Wilayah", out ContentControl countryHost);
            ...
            var tierPanel = CreateSmsBowerDialogRow("Tingkat Nomor", out ContentControl tierHost);
            ...
            void RefreshInventory()
            {
                ...
                {
                    inventory.Text = $"Stok saat ini {tier.Count} buah, harga ${tier.Price} / buah";
                }
                else
                {
                    inventory.Text = "";
