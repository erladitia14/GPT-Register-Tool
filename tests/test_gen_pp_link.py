...
class GeneratePpLinkContractTests(unittest.TestCase):
    ...
    def test_hosted_strict_zero_rejects_unknown_amount(self):
        ...
        # Ketika jumlah tidak dapat diambil, secara kabur dikategorikan sebagai 'unknown' sesuai protokol. Tidak boleh diloloskan sebagai 0, juga tidak boleh ditolak sebagai non-nol.
        # Jalur ini tidak masuk ke cabang sukses ok=True; ok=False; dibedakan oleh error_code."Jumlah tidak diketahui"。
        self.assertFalse(result["ok"])
