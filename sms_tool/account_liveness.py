...
def _quota_status_label(payload: dict[str, Any], status_code: int, error_text: str = "") -> str:
    ...
    if 200 <= status_code < 300:
        return "Tersedia"
    return f"HTTP {status_code}" if status_code else "Tidak Dikenal"
